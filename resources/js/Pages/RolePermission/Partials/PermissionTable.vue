            ...
            <table class="w-full whitespace-no-wrap">
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="px-4 py-3 text-sm">{{ dayjs(permission.created_at).format('HH:mm A, YYYY-MM-DD') }}</td>
                        <td class="px-4 py-3 text-sm">{{ dayjs(permission.updated_at).format('HH:mm A, YYYY-MM-DD') }}</td>
                        <td class="px-4 py-3">
